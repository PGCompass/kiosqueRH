...
(function() {
    ...
    const Inactive_employees = ["LU JUN", "CISSE AMINATA", "SOW SIMBALA", "BAH ALPHA A", "ID HAISSOU NOUZHA", "DEREVIANKI EMILIE", "MEGUERDITC JEAN MA", "DREAN FLORENC", "COMMAILLE ELODIE", "AMGHAR SABIHA", "DUCLOS LOIC", "CABY ANGELIQ", "ABE TEWABEC", "HAMZA MAKRAM"];
