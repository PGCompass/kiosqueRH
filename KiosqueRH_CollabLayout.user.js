...
(function() {
    ...
    const Inactive_employees = ["LU JUN", "CISSE AMINATA", "SOW SIMBALA", "BAH ALPHA A", "ID HAISSOU NOUZHA", "DEREVIANKI EMILIE", "MEGUERDITC JEAN MA", "IMAM FATIHA", "DREAN FLORENC", "COMMAILLE ELODIE", "BEN HAMMOU RIDHA", "AMGHAR SABIHA", "DUCLOS LOIC", "LECLERCQ SARAH", "CABY ANGELIQ", "ABE TEWABEC"];
